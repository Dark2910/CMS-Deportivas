<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="deportivas_consulta_documentos_nota.aspx.vb" Inherits="Default2" title="Untitled Page" %>
...
<main class="main">
    <section class="main-content container">
        <h2>documentos nota</h2><hr/>
        <br />
        <div class="container">
            <div class="table table-responsive table-hover small">
                <asp:GridView ID="tbl_documentos_nota" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None"
...
<section class="section">
  <div class="section-content container">
    <h2>Alta documento nota</h2><hr />

    <div class="section-forms">
      <asp:FileUpload ID="FileUpload_documento_nota" runat="server" /><br />
      <br />
      <label for="title">nombre archivo:</label>
      <asp:TextBox ID="txt_dnota_nombre" runat="server" Width="20%"></asp:TextBox><br />
      <br />
      ...
      <div style="text-align: right;">
        <button id="btn_alta_documento_nota" type="submit" class="btn btn-success btn-block" runat="server"
