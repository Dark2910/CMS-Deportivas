<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="deportivas_cambio_galeria_calendario.aspx.vb" Inherits="Default2" title="Untitled Page" %>
...
<section class="section">
  <div class="section-content container">
    <h2>cambio galeria calendario</h2><hr />
    ...
    <div class="section-forms">
      ...
      <div style="text-align: right;">
        <button type="submit" id="btn_cambio_foto_calendario" class="btn btn-warning btn-block text-white" runat="server"
