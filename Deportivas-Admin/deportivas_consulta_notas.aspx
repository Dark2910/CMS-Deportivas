<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="deportivas_consulta_notas.aspx.vb" Inherits="Default2" title="Untitled Page" %>
    ...
    <section class="main-content container">
        ...
        <div class="container">
            <div class="table table-responsive table-hover small">
                <asp:GridView ID="tbl_notas" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None"
      ...
      <form action="">
        ...
        <div class="input-group">
          ...
          <div class="input-group mb-2">
            <asp:RequiredFieldValidator ID="vdNotaTitulo" runat="server" ErrorMessage="*Ingrese titulo"
        ...
        <button type="submit" id="btn_alta_nota" class="btn btn-success btn-block" runat="server"
          validationgroup="1">AGREGAR NOTA</button>
      </form>
