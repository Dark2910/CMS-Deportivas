<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="deportivas_consulta_galeria_calendario.aspx.vb" Inherits="Default2" title="Untitled Page" %>
...
<main class="main">
    <section class="main-content container">
        <h2>galeria calendario</h2><hr/>
        <br />
        <div class="container">
            <div class="table table-responsive table-hover small">
                <asp:GridView ID="tbl_galeria_calendario" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None"
...
<section class="section">
  <div class="section-content container">
    <h2>Alta galeria calendario</h2><hr />

    <div class="section-forms">
      <asp:FileUpload ID="FileUpload_foto_calendario" runat="server" /><br />
      <br />
      <label for="title">nombre archivo:</label>
      <asp:TextBox ID="txt_fcalendario_nombre" runat="server" Width="20%"></asp:TextBox><br />
      <br />
      ...
      <div style="text-align: right;">
        <button id="btn_alta_galeria_calendario" type="submit" class="btn btn-success btn-block" runat="server"
