<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="deportivas_cambio_deporte.aspx.vb" Inherits="Default2" title="Untitled Page" %>
    ...
    <section class="main-content container">
        ...
        <div class="container">
            <div class="table table-responsive table-hover small">
                <asp:GridView ID="tbl_deporte" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None"
      ...
      <form action="">
        ...
        <div class="input-group">
          ...
          <div class="input-group mb-2">
            <asp:RequiredFieldValidator ID="vdDeporteNombre" runat="server" ErrorMessage="*Ingrese un nombre"
        ...
        <div class="input-group">
          ...
          <div class="input-group mb-2">
            <asp:RequiredFieldValidator ID="vdDeporteObjetivo" runat="server" ErrorMessage="*Ingrese subtitulo"
        ...
        <div class="input-group">
          ...
          <div class="input-group mb-2">
            <asp:RequiredFieldValidator ID="vdDeporteDescripcion" runat="server" ErrorMessage="*Ingrese texto"
              ControlToValidate="txtDeporteDescripcion" ValidationGroup="1"></asp:RequiredFieldValidator>
          </div>
        </div>
        
        <button type="submit" id="btn_cambio_deporte" class="btn btn-warning btn-block text-white" runat="server"
            validationgroup="1">MODIFICAR DEPORTE</button>
      </form>
