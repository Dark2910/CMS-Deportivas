<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="deportivas_consulta_galeria_deporte.aspx.vb" Inherits="Default2" title="Untitled Page" %>
...
<section class="section">
  <div class="section-content container">
    <h2>Alta galeria deporte</h2><hr />

    <div class="section-forms">
      <asp:FileUpload ID="FileUpload_fotos_deporte" runat="server" /><br />
      <br />
      <label for="title">nombre archivo:</label>
      <asp:TextBox ID="txt_fdeporte_nombre" runat="server" Width="20%"></asp:TextBox><br />
      <br />
      ...
      <div style="text-align: right;">
        <button id="btn_alta_galeria_deporte" type="submit" class="btn btn-success btn-block" runat="server"
