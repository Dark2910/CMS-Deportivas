<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="deportivas_cambio_grupo.aspx.vb" Inherits="Default2" title="Untitled Page" %>
    ...
    <section class="main-content container">        
        ...
        <div class="container">
            <div class="table table-responsive table-hover small">
                <asp:GridView ID="tbl_grupo" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None"
  ...
  <div class="section-content container">
    ...
    <div class="section-forms">
      <form action="">
        ...
        <button type="submit" id="btn_modificar_grupo" class="btn btn-warning btn-block text-white" runat="server"
            validationgroup="1">MODIFICAR GRUPO</button>
      </form>
