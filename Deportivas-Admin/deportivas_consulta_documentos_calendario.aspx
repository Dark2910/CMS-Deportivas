<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="deportivas_consulta_documentos_calendario.aspx.vb" Inherits="Default2" title="Untitled Page" %>
...
<main class="main">
    <section class="main-content container">
        <h2>documentos calendario</h2><hr/>
        <br />
        <div class="container">
            <div class="table table-responsive table-hover small">
                <asp:GridView ID="tbl_documentos_calendario" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None"
...
<section class="section">
  <div class="section-content container">
    <h2>Alta documento calendario</h2><hr />

    <div class="section-forms">
      <asp:FileUpload ID="FileUpload_documento_calendario" runat="server" /><br />
      <br />
      <label for="title">nombre archivo:</label>
      <asp:TextBox ID="txt_dcalendario_nombre" runat="server" Width="20%"></asp:TextBox><br />
      <br />
      ...
      <div style="text-align: right;">
        <button id="btn_alta_documento_calendario" type="submit" class="btn btn-success btn-block" runat="server"
          validationgroup="1">AGREGAR DOCUMENTO</button>
      </div>
