<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="deportivas_cambio_documento_calendario.aspx.vb" Inherits="Default2" title="Untitled Page" %>
    ...
    <section class="main-content container">
        ...
        <div class="container">
            <div class="table table-responsive table-hover small">
                <asp:GridView ID="tbl_documento_calendario" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None"
...
<section class="section">
  <div class="section-content container">
    <h2>Cambio documento calendario</h2><hr />
    ...
    <div class="section-forms">
      ...
      <div style="text-align: right;">          
        <button type="submit" id="btn_cambio_documento" class="btn btn-warning btn-block text-white" runat="server"
            validationgroup="1">MODIFICAR DOCUMENTO</button>
      </div>
