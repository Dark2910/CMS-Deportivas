<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="deportivas_cambio_galeria_nota.aspx.vb" Inherits="Default2" title="Untitled Page" %>
  ...
  <div class="section-content container">
    ...
    <div class="section-forms">
      ...
      <div style="text-align: right;">
        <button type="submit" id="btn_cambio_foto_nota" class="btn btn-warning btn-block text-white" runat="server"
