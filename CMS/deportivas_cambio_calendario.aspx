<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="deportivas_cambio_calendario.aspx.vb" Inherits="Default2" title="Untitled Page" %>
  ...
  <div class="section-content container">
    ...
    <div class="section-forms">
      <form action="">
        ...
        <button type="submit" id="btn_modificar_calendario" class="btn btn-warning btn-block text-white" runat="server"
            validationgroup="1">MODIFICAR CALENDARIO</button>
      </form>
